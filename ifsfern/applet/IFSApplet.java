 ...
 * @author Bilbo
 */
public class IFSApplet extends javax.swing.JApplet implements ActionListener, ChangeListener{
    ...
    /** Initializes the applet ifsapp2 */
    @Override
    public void init() {
    ...
    public void buildFern(){
        ...
        /**
     * just a few necessary applet things
     */
    @Override
    public void start(){
		// nothing
